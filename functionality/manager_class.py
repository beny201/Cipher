...
class Manager:
    ...
    def process_encryption(self):
        ...
        if user_choice == 1:
            encrypted_message = Rot13(user_message_to_encrypt).rot()
            ...
            encrypted_message = Rot47(user_message_to_encrypt).rot()
            message_to_stock = Text(encrypted_message, "Rot47", "Encrypted")
            self.buffer.append_text(message_to_stock)
        else:
            print(f"Please chose no from range 1 - {len(self.action_submenu)}")
